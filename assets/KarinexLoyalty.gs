...
function doGet(e) {
  ...
  try {
    switch (action) {
      ...
      default:
        return asJson_({ ok: true, service: 'karinex-loyalty', version: '2.4' });
    }
  } catch (err) {
...
+ '</div>'
+ '<div class="sb-f">Karinex Loyalty v2.4</div>'
+ '</nav>'
+ '<div class="mn">'
