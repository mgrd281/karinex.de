...
export class Slideshow extends Component {
  ...
  async select(input, event, options = {}) {
    ...
    // Force hide all other slides to prevent ghosting during transition
    // User reported Slide 4 flashing when moving 1->2. Strict visibility ensures only relevant slides are seen.
    slides.forEach((s) => {
      if (s !== slide && s !== currentSlide) {
